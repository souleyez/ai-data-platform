...
switch ($Action) {
  ...
  'auth' {
    ...
    & powershell -ExecutionPolicy Bypass -File (Join-Path $PSScriptRoot 'auth-client.ps1') -Phone $Phone
  }
  'lease-model' {
    & powershell -ExecutionPolicy Bypass -File (Join-Path $PSScriptRoot 'lease-client-model.ps1') -ProviderScope $ProviderScope
  }
  'check-update' {
    & powershell -ExecutionPolicy Bypass -File (Join-Path $PSScriptRoot 'check-client-update.ps1')
  }
  'download-update' {
  ...
  'start' {
    & powershell -ExecutionPolicy Bypass -File (Join-Path $PSScriptRoot 'start-client-runtime.ps1') -Phone $Phone
  }
  'stop' {
