...
(
  ...
  nohup env \
    ...
    OPENCLAW_LOCAL_PROVIDER_TIMEOUT_MS="${OPENCLAW_LOCAL_PROVIDER_TIMEOUT_MS:-120000}" \
    OPENCLAW_LOCAL_WSL_CHAT_TIMEOUT_MS="${OPENCLAW_LOCAL_WSL_CHAT_TIMEOUT_MS:-120000}" \
