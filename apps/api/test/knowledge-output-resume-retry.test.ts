...
test('normalizeReportOutput should top up resume client visuals to the minimum client shell', () => {
  const documents: ParsedDocument[] = [
    {
      path: 'resume-1.pdf',
      name: 'resume-1.pdf',
  ...
  const output = normalizeReportOutput(
    ...
    JSON.stringify({
      ...
      summary: '聚焦一位具备智能座舱与 AIGC 背景的候选人。',
      cards: [
        { label: '候选人覆盖', value: '1人', note: '已进入主展示' },
        { label: '公司覆盖', value: '1家', note: '阿里斑马网络' },
        { label: '项目匹配', value: '2项', note: '智能座舱与 AIGC 平台' },
      ],
      sections: [
        { title: '客户概览', body: '候选人聚焦产品与平台协同，适合客户沟通场景。' },
        { title: '代表项目', body: '核心项目覆盖智能座舱平台和 AIGC 能力平台。' },
        { title: 'AI综合分析', body: '整体画像更适合作为客户沟通和能力展示样板。' },
      ],
      charts: [
        {
          title: '公司覆盖分布',
          items: [{ label: '阿里斑马网络', value: 1 }],
        },
      ],
    }),
    {
