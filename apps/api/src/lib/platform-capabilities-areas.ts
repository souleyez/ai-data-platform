...
export const PLATFORM_CAPABILITY_AREAS: PlatformCapabilityArea[] = [
  ...
  },
  {
    ...
    commands: [
      { key: 'supply.preview', command: 'pnpm system:control -- supply preview --prompt \"<request>\" [--library \"<library>\"] [--time-range \"<range>\"] [--focus \"<focus>\"]', description: 'Preview matched libraries, documents, and evidence for a natural-language request.' },
    ],
  },
  {
    id: 'datasources',
