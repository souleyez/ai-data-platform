...
export const DATASOURCE_PRESETS: DatasourcePreset[] = [
  {
    ...
    kind: 'web_discovery',
    category: 'bids',
    authority: '国家级公共资源交易平台',
    baseUrl: 'https://www.ggzy.gov.cn/',
    description: '适合按地区、行业、关键词持续采集公开招标、结果公告与变更公告。',
  ...
  },
  {
    ...
    description: '适合政府采购公告、结果公告、政策法规和地方采购分网持续采集。',
  ...
  },
  {
    ...
    description: '适合公开全文论文、方法、结果、结论和表格内容持续采集。',
  ...
  },
  {
    ...
    description: '适合 AI、计算机、数学等方向的公开论文持续采集。',
  ...
  },
  {
    ...
    description: '适合公共卫生研究报告、政策建议和数据报告采集。',
