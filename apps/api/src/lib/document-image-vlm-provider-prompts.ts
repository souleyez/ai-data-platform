...
import type { OpenClawChatRequest } from './openclaw-adapter.js';
import { env, resolveWslReadableImagePath, sanitizeText } from './document-image-vlm-provider-runtime.js';
import type {
  DocumentImageVlmCapability,
} from './document-image-vlm-capability.js';
import type {
...
export function parseDocumentImageVlmPayload(raw: string) {
