...
function adaptOrderEnvelope(
  ...
  if (kind === 'page') {
    if (view === 'generic') {
      return {
        ...
        title: '订单多渠道经营驾驶舱',
        fixedStructure: [
          '按经营驾驶舱方式组织渠道、SKU、库存、补货和异常解释。',
          '优先突出跨渠道结构、核心SKU集中度和库存健康。',
          '页面要适合经营复盘、周会汇报和客户展示。',
        ],
        variableZones: ['经营总览', '渠道结构', 'SKU与品类焦点', '库存与补货', '异常波动解释', '行动建议', 'AI综合分析'],
        outputHint: '输出多渠道、多SKU订单经营静态页，突出渠道贡献、结构变化、库存风险和补货优先级。',
    ...
    if (view === 'platform') {
      return {
        ...
        title: '订单渠道经营驾驶舱',
        fixedStructure: [
          '按渠道维度组织GMV、订单、动销SKU、库存和增量来源。',
          '突出各渠道在增长、利润和补货节奏上的不同角色。',
          '页面要适合渠道复盘、经营周会和客户展示。',
        ],
        variableZones: ['经营总览', '渠道结构', '平台角色与增量来源', 'SKU动销焦点', '库存与补货', '异常波动解释', 'AI综合分析'],
        outputHint: '按渠道维度输出订单经营驾驶舱，突出渠道贡献结构、平台角色、SKU焦点和补货动作。',
        pageSections: ['经营总览', '渠道结构', '平台角色与增量来源', 'SKU动销焦点', '库存与补货', '异常波动解释', 'AI综合分析'],
      };
    }
    if (view === 'category') {
      return {
        ...
        title: '订单品类/SKU经营驾驶舱',
        fixedStructure: [
          '按品类与SKU层级组织GMV、销量、动销率、毛利和库存状态。',
          '优先突出品类梯队、核心SKU集中度和高风险尾部SKU。',
          '页面要能直接支持品类经理做补货和促销决策。',
        ],
        variableZones: ['经营总览', '品类梯队', 'SKU集中度', '动销与毛利焦点', '库存与补货', '异常波动解释', 'AI综合分析'],
        outputHint: '按品类与SKU维度输出经营驾驶舱，突出品类梯队、SKU集中度、库存压力和动作优先级。',
    ...
    return {
      ...
      title: '库存与补货驾驶舱',
      fixedStructure: [
        '按库存健康、缺货风险、滞销压力和补货动作组织静态页。',
        '优先突出高风险SKU、周转异常和72小时内必须处理的补货队列。',
        '页面要适合供应链、运营和销售共同查看。',
      ],
      variableZones: ['经营总览', '库存健康', '高风险SKU', '动销与周转', '补货优先级', '异常波动解释', 'AI综合分析'],
      outputHint: '按库存维度输出补货驾驶舱，突出库存健康、高风险SKU、周转异常和补货优先级。',
  ...
  if (view === 'platform') {
    return {
      ...
      title: '订单渠道维度表',
      fixedStructure: [
        '按渠道维度整理GMV、订单、动销SKU、库存和异常波动。',
        '优先突出渠道间贡献差异与补货动作。',
      ],
      variableZones: ['渠道、GMV/订单、同比环比、动销SKU、库存指数、补货动作'],
      outputHint: '按渠道维度输出订单经营表。',
      tableColumns: ['渠道', 'GMV/订单', '同比/环比', '动销SKU', '库存指数', '补货动作'],
    };
  }
  if (view === 'category') {
    return {
      ...
      title: '订单品类/SKU维度表',
      fixedStructure: [
        '按品类与SKU维度整理订单表现、动销率、库存状态和补货建议。',
        '优先突出重点品类、核心SKU和尾部风险SKU。',
      ],
      variableZones: ['品类、核心SKU、GMV/销量、动销率、库存周转、补货动作'],
      outputHint: '按品类与SKU维度输出订单经营表。',
      tableColumns: ['品类', '核心SKU', 'GMV/销量', '动销率', '库存周转', '补货动作'],
    };
  }
  return {
    ...envelope,
    title: '库存与补货维度表',
    fixedStructure: [
      '按库存维度整理风险SKU、库存健康、近30天销量和补货动作。',
      '优先突出缺货、滞销和跨仓调拨优先级。',
    ],
    variableZones: ['SKU、库存健康、风险等级、近30天销量、建议补货量、处理动作'],
    outputHint: '按库存维度输出补货经营表。',
    tableColumns: ['SKU', '库存健康', '风险等级', '近30天销量', '建议补货量', '处理动作'],
  };
}
