...
export function buildKnowledgeOutputPrompt(
  ...
  return [
    ...
    'The local report center is an available publish target for reusable page, table, and document outputs.',
    'If the result naturally becomes a reusable artifact, you may treat publishing to the report center as an option; otherwise answer directly without forcing publication.',
...
export function buildKnowledgeConceptPagePrompt(
  ...
  return [
    ...
    'The local report center is an available publish target for reusable static pages and other report artifacts.',
    'If the page becomes a reusable artifact, you may treat publishing it to the report center as an available choice; otherwise keep the result direct.',
