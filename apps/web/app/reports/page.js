...
function ReportsPageContent() {
  ...
  useEffect(() => {
    if (!generatedId || !generatedReport || !isDraftGeneratedReport(generatedReport)) return;
    router.replace(buildDraftEditorPath(generatedReport));
  }, [generatedId, generatedReport, router]);
